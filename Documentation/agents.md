...
| Alma Linux (EL)| 9.2 (Compatibility with RedHat 9)| tar.gz| [Alma tar.gz](https://github.com/xcomponent/appcontrol-documentation/releases/latest/download/almalinux.tar.gz)|
...
| Rocky Linux (EL)| 9.2 (Compatibility with RedHat 9) | tar.gz| [Rocky Linux](https://github.com/xcomponent/appcontrol-documentation/releases/latest/download/rockylinux.tar.gz)|
