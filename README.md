...
| Getting Started | - [Get started](#markdown-header-get-started) - [How to create your application map?](./Documentation/map.md)<br/> - [Enrich your application with dynamic informations](./Documentation/appcontrol_worker/dynamicmapinformations.md)<br/>
